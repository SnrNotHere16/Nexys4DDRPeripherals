...
HD_PWD='C:/Users/OAkun/Documents/GitHub/FPGADivision/FloatingPointDivisionNexys4DDR/FPFPGA/SevenSegmentDisplay/SevenSegmentDisplay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SevenSegmentDisplayTopTest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SevenSegmentDisplayTopTest.tcl
