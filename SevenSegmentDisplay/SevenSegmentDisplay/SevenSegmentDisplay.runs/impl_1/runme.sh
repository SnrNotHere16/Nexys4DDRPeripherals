...
HD_PWD='C:/Users/OAkun/Documents/GitHub/FPGADivision/FloatingPointDivisionNexys4DDR/FPFPGA/SevenSegmentDisplay/SevenSegmentDisplay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SevenSegmentDisplayTopTest.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SevenSegmentDisplayTopTest.tcl -notrace
